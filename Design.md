...
- The public booking page states plainly that website bookings are online on Google Meet. A restrained three-step editorial guide runs horizontally on landscape screens and vertically on mobile before the form. The confirmed state and customer email both say that the Google Meet link is shared by email. Contact-page FAQs repeat the online format and direct cancellations and refund questions to the studio phone without implying an automatic refund.
