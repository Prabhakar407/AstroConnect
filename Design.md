...
- All Services chapters retain their compact spacing while alternating a restrained gold-beige wash from the artwork side toward transparency. The wash ends inside the established reading frame rather than becoming an edge-to-edge page band, and is quieter on portrait/mobile layouts.
...
- The featured testimonial advances every 2 seconds until the visitor pauses or manually operates it. The review collection uses 30 client-authorized provisional accounts: six are visible under All Experiences and three under a service filter. One visible card is replaced every 2.5 seconds from the unseen category pool, with duplicate visible accounts prevented and motion paused while offscreen, hidden, hovered or reduced by the visitor’s system preference.
