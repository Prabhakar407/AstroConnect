  ...
  return (
    <div className="w-full min-h-screen bg-[#FDFCF5] relative flex flex-col items-center font-sans text-[#181122]">
      ...
      <div className="w-full bg-white py-8 px-4 flex flex-col items-center relative z-10 overflow-hidden">
        ...
        {/* Cancellation Notice */}
        <div className="mt-8 mb-12 max-w-xl w-full px-4">
          <div className="bg-amber-500/5 border border-amber-500/10 rounded-2xl p-4 flex items-center gap-3">
            ...
            <p className="text-xs text-slate-600 font-sans text-left leading-relaxed">
