      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-[#AB7A57]/10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 pt-2">
            {/* Facebook */}
            <a href="#" className="w-8 h-8 rounded-full bg-white/5 hover:bg-[#D3AF54] text-[#D3AF54] hover:text-[#181122] border border-[#D3AF54]/30 hover:border-[#D3AF54] flex items-center justify-center transition-all duration-300">
        ...
        <div className="space-y-4 text-left">
          ...
          <ul className="space-y-2.5 text-xs text-[#D8CFEB]">
            <li className="flex items-center gap-2">
              <Phone size={14} className="text-[#D3AF54]" />
              <span>☎ +91 94520 62153</span>
            </li>
            <li className="flex items-center gap-2">
              <Mail size={14} className="text-[#D3AF54]" />
              <span>astrologerkundan@gmail.com</span>
            </li>
            <li className="flex items-center gap-2">
              <MapPin size={14} className="text-[#D3AF54]" />
              <span>Varanasi, Uttar Pradesh, India</span>
            </li>
            <li className="flex items-center gap-2">
              <Clock size={14} className="text-[#D3AF54]" />
              <span>Mon - Sat: 9:00 AM - 7:00 PM</span>
            </li>
            <li className="flex items-center gap-2">
              <MessageCircle size={14} className="text-[#D3AF54]" />
        ...
        <div className="hidden lg:flex flex-col items-center justify-center relative w-full h-full">
          <div className="w-32 h-32 rounded-full border border-[#D3AF54]/20 flex items-center justify-center animate-[spin_120s_linear_infinite]">
            ...
            <span className="text-[#D3AF54]/40 text-xl">✨</span>
          </div>
        </div>
